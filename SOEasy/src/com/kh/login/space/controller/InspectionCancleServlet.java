...
/**
 * Servlet implementation class InspectionCancleServlet
 */
@WebServlet("/inspectionCancle")
public class InspectionCancleServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public InspectionCancleServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		result = new SpaceService().cancleInspection(spaceNo);
